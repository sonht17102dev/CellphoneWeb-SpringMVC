...
<div class="wrapper">
	...
	<div class="product-info">
		<div class="product-text">
			...
			<p><span>
			<fmt:formatNumber type="number" groupingUsed = "true" value="${product.price}"/>VND</span></p>
		</div>
		<div class="product-price-btn">
			<form action="${pageContext.request.contextPath}/addtocart" method="get" style="margin-top: -17px;">
...
<script src="<c:url value = "/resources/js/quantity.js"/> ">
</script>