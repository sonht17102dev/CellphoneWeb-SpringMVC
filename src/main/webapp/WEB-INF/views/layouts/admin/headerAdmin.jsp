...
<div class="sidebar col-12 col-lg-2 d-block">
	<div class="left-sidebar">
		...
		<ul class="flex-column nav-pills">
			<li class="nav-item">
				<p class="nav-link logo">${username == null ? "Welcome to Admin page" : username}</p>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item"><a class="nav-link active"
				aria-current="page" href="/CellPhoneApp/admin/"> <svg
			...
			<li class="nav-item"><a class="nav-link" href="createAccount">Add
					New Account</a>
		</ul>
	</div>
</div>
